...
class PostControllerQB extends Controller
{
    ...
    function create(Request $request, $userId) {
        ...
        if ($request->isMethod('get')) {
            return view('qb.post_create_form', [
                'user' => $user,
                'tags' => $tags
            ]);
        }
        ...
        return redirect()->route('qb.post.index', ['userId' => $userId]);
    }
    ...
    function update(Request $request, $userId, $postId) {
        ...
        if ($request->isMethod('get')) {
            return view('qb.post_update_form', [
                'user' => $user,
                'tags' => $tags,
                'post' => $post
            ]);
